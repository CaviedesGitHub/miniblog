...
def configure_logging(app):
    ...
    if (app.config['APP_ENV'] == app.config['APP_ENV_LOCAL']) or (
        ...
        print("app.config['DONT_REPLY_FROM_EMAIL']: ", app.config['DONT_REPLY_FROM_EMAIL'])
        print("app.config['ADMINS']: ", app.config['ADMINS'])
        print("app.config['APP_ENV']: ", app.config['APP_ENV'])
